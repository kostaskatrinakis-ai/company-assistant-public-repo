...
import { queueInvoiceReminder } from "@/modules/reminders/service";
...
export async function POST(
  ...
  try {
    ...
    const reminder = await queueInvoiceReminder(id, auth.user);
    ...
    return errorResponse("INTERNAL_ERROR", "Αποτυχία queue στο reminder.", 500);
  }
}
